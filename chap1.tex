...
\end{figure}
More specifically, \textbf{this thesis deals with the reengineering of Flango \cm , the part of the system deployed \textbf{in the robot}} that displays contents applications on the touchscreen of \reem{H} (\fref{fig:intro-system-overview}).
