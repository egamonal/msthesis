...
More specifically, this thesis deals with the reengineering of Flango \cm , the part of the system deployed in the robot that displays contents applications on the touchscreen of \reem{H}.
...
\reem{H} robots have a built-in software to display the content applications. 
...
\textbf{This thesis documents the project to re-engineer the \cm , in the robot, to use modern web technologies instead of \flash}.
