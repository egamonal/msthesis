...
This thesis is the work done at \company .
I owe many thanks to the team that helped me understand the system and a field, robotics, that was new to me.
My colleague Eric Marcos and my director Daniel Pinyol guided and supported me specially in the first weeks of this project, and Dr Ricardo Tellez reviewed part of this document and provided invaluable insights.
...
Daniel Andersson, Oriol Arcas, Margaux Bigotte,  Oriol Collell, Clara Cowley, Jordi Franc\`{e}s, Roger Llorens, Jos\'{e} Manuel L\'{o}pez, H\`{e}ctor Manrique, \'{A}lvaro Mart\'{i}nez, Kamilla Nyborg, Marc Rodr\'{i}guez, and Anna Rosich.
...
Finally, I would like to thank my professor N\'{u}ria Castell for her guidance and support while I completed this work.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% -*-latex-*-
