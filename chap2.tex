...
The browser has become the most used application in many devices. 
The web makes documents like tax records, maps, banking information, phone directories or product catalogues accessible.
...
More recently, despite the fact that the web browser was not designed for \textbf{running applications}, since 2008 users have headed this way. 
...
They can be document-centric, workflow-based, portal-oriented, collaborative, social, etc. 
...
The project of this thesis does the first phase with QtWebKit, the port of WebKit on top of Qt, to display the application in a Qt window and communicate with the hardware. 
...
The \ac{QA} process is easier to maintain and stricter.
