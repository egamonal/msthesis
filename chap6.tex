...
Thus, any element \texttt{$<fl:ui>$} or concrete types \texttt{base-button}, \texttt{back-button}, etc has a \texttt{scope} object attached that contains all the necessary data to render an \ac{HTML} node \fref{fig:design-properties-management}.
