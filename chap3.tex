...
The new \cm accepts a contents application as input, generated with the \se, and outputs the screen rendered with web elements.
...
This project accepts valid syntax generated with the \se for a comprehensive set of components (back-button, base-button, image, video...) and their properties (width, x, y, background...), and generates \ac{HTML5} that renders them as defined.
