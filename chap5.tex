...
\begin{suc}
{Change language}
{A user changes the language of the \ac{UI}}
{Content Application User}
{robotBehaviour is running}
{
    \begin{enumerate}
        \item The current screen is shown with the chosen language
        \item The current language is set to the chosen language
    \end{enumerate}
}
{main scenario
    \begin{enumerate}
