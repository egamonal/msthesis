...
\begin{enumerate}
    ...
    \item The Content Manager uses the settings to decide which application to load, the language, the theme, etc. Requests application-specific settings and the application structure. After this, it requests the screens (the \ac{XML} files) to the Backend
...
Notice that all files in \ref{uicomponents-list} have the corresponding class in the conceptual model.
The elements of \ref{uithemecomponents-list} are in fact folders but they can be considered objects in this specification as they are part of the domain of the problem.
