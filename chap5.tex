...
However, Flango uses other software that might have to be reengeneered in the future.
list software, current status, etc and whatever pressman says

applications involved in the flango project: robot content management, frontend and screens editor, backend
